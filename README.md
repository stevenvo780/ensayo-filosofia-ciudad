...
Rutas: `/` (ensayo) · `/tesis` (tesis de respaldo) · `/presentacion` (deck animado). Despliegue en
...
web/                       Sitio React/Vite (ensayo + tesis + presentación animada)
GUION-DEFENSA.md           Guion de la exposición oral + kit anti-objeciones
CONSIGNA.md                La consigna del curso
CRITICA.md, CRITICA2.md    Auto-críticas del proceso (evidencia de rigor)
