# Teoría de la decisión — el margen que ningún optimizador fija

¿Existe una métrica «objetivamente correcta» para decidir el centro de la ciudad? La **teoría de la decisión** formal (minimax-regret) responde que no: hay un resto irreducible que es, justamente, lo político.
